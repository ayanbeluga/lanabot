...
INCORRECT_CARD = '**Your Given Input Is Incorrect.**'
EMPTY_CARD = '**Your Given Input Is Empty.**'
INVALID_CARD = '**Your Given Input Is Invalid.**'
SHORT_CARD = '**Your Given Input Is Too Short.**'
INCORRECT_MONTH = '**Your Given Input Month Is Invalid.**'
INCORRECT_YEAR = '**Your Given Input Year Is Invalid.**'
INCORRECT_CVV = '**Your Given Input Cvv Is Invalid.**'
